...
class CreateWebkioskLayout2ConfigurationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('webkiosk_layout_2_configuration', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('webkiosk_layout_2_configuration');
    }
}
