...
class Detail extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'total_waiting' => DirectQueue::whereServiceId($this->service_id)->whereStatus('waiting')->whereDate('created_at', date('Y-m-d'))->count(),
            'currently_attending' => DirectQueue::whereServiceId($this->service_id)->whereStatus('served')->whereDate('created_at', date('Y-m-d'))->count(),
