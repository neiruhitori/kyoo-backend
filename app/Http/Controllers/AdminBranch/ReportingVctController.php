...
use App\Exports\ReportingVctExport;
use App\Service;
use App\WorkstationVct;

class ReportingVctController extends Controller
{
    private $months;
    ...
    {
        return view('adminBranch.report.vct', [
    ...
    private function getData(Request $request)
    {
        ...
        $data = $this->reportingVct->getReport($request);
        
        return $data->map(function ($value) {
            $workstationId = null;
            if ($worksationVct = WorkstationVct::where('vct_id', $value->vct_id)->first()) {
