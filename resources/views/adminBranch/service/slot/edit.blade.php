        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('admin-branch.branch-configuration.slot.update', $slot->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="max_slots">{{ __('Maximum Slot') }}</label>
                                    <input name="max_slots" type="number" class="form-control @error('max_slots') is-invalid @enderror" value="{{old('max_slots') ?: $slot->max_slots}}" min='1' required>
...
@push('js')
    <script>
        $(document).ready(function() {
            const dayOldValue = '{{ old('day') ?: $slot->day }}';
