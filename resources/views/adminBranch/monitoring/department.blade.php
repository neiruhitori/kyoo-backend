            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <select class="form-control" id="departmentId" autocomplete="off">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center">
                            <label for="refreshInterval" class="mr-2">Refresh interval (menit)</label>
                        ...
                        <table class="table table-bordered mb-4" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" class="align-middle">Menunggu</th>
                                    <th rowspan="2" class="align-middle">Dilayani</th>
                                    <th rowspan="2" class="align-middle">Tidak Hadir</th>
