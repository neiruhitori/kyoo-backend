        ...
        <div class="col-xl-12 col-lg-7">
            ...
            <div class="card shadow mb-4">
                {{-- <div class="card-header py-3"> --}}
                    ...
                    <div class="card-body">
                    <h5 class="mb-4 font-weight-bold" style="color: #103C7C">{{ __('Service Report') }}</h5>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#pdfButton").click(function (e) {
            window.open("{{ route('admin-branch.report.service.pdf') }}?" + new URLSearchParams(filter))
        })

        $("#excelButton").click(function (e) {
            window.open("{{ route('admin-branch.report.service.excel') }}?" + new URLSearchParams(filter))
        })
    ...
    async function feedTable() {
        ...
        const res = await axios.get('/admin-branch/report/service/all', {
            params: filter
        })
            .then(res => res.data)
            .catch(err => {
