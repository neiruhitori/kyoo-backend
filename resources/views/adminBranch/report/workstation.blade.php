    ...
    <div class="row">
        <div class="col-xl-12 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h5 class="mb-4 font-weight-bold" style="color: #103C7C">{{ __('Workstation Report') }}</h6>
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <a href="{{ route('admin-branch.report.workstation.chart') }}" class="btn btn-outline-dark">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#pdfButton").click(function (e) {
            window.open("{{ route('admin-branch.report.workstation.pdf') }}?" + new URLSearchParams(filter))
        })

        $("#excelButton").click(function (e) {
            window.open("{{ route('admin-branch.report.workstation.excel') }}?" + new URLSearchParams(filter))
        })
    ...
    async function feedTable() {
        ...
        const res = await axios.get('/admin-branch/report/workstation/all', {
            params: filter
        })
            .then(res => res.data)
            .catch(err => {
