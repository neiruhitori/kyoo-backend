...
<div class="row">
    <div class="col-xl-6 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Number of Service Queues') }}</h6>
            </div>
    ...
    <div class="col-xl-6 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Percentage of Service Queues') }}</h6>
            </div>
...
<script>
    ...
    $(document).ready(async function () {
        ...
        $("#department_id").change(async function (e) {
            $("#service_id").html(["<option value disabled selected>Loading...</option>"])
            
            const res = await axios.get(`/api/service/department/${e.target.value}`)
    ...
    async function fetchData() {
        ...
        return await $.ajax('{{ route('admin-branch.report.service.chart.all') }}', {
            method: 'GET',
            dataType: 'json',
            data: params
        })
