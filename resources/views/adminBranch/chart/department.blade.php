...
<div class="row">
    <div class="col-xl-6 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Number of Department Queues') }}</h6>
            </div>
    ...
    <div class="col-xl-6 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Percentage of Department Queues') }}</h6>
            </div>
...
<script>
    ...
    async function fetchData() {
        ...
        return await $.ajax(`{{ route('admin-branch.report.department.chart.all') }}`, {
            method: 'GET',
            dataType: 'json',
            data: params
        })
