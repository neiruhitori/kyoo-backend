                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="wrapper-group-action col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                <label for="running_text_speed">{{ __('Size') }}</label>
                                                <select class="custom-select" name="running_text_size">
                                                    <option value="1" {{$layout_configuration->running_text_size == "1" ? 'selected' : ''}}>Default</option>
                                                    <option value="1.5"{{$layout_configuration->running_text_size == "1.5" ? 'selected' : ''}}>x2 Size</option>
                                                    <option value="2"{{$layout_configuration->running_text_size == "2" ? 'selected' : ''}}>x4 Size</option>
                                                    <option value="2.5"{{$layout_configuration->running_text_size == "2.5" ? 'selected' : ''}}>x6 Size</option>
                                                    <option value="3"{{$layout_configuration->running_text_size == "3" ? 'selected' : ''}}>x8 Size</option>
                                                  </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" name="logo_size">
                                                    ...
                                                    <option value="3.3"{{$layout_configuration->logo_size == "3.3" ? 'selected' : ''}}>x2 Size</option>
                                                    <option value="4.3"{{$layout_configuration->logo_size == "4.3" ? 'selected' : ''}}>x4 Size</option>
                                                    <option value="5.3"{{$layout_configuration->logo_size == "5.3" ? 'selected' : ''}}>x6 Size</option>
                                                    <option value="6.3"{{$layout_configuration->logo_size == "6.3" ? 'selected' : ''}}>x8 Size</option>
                                                  </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" name="text_time_size">
                                                    ...
                                                    <option value="1.2"{{$layout_configuration->text_time_size == "1.2" ? 'selected' : ''}}>x2 Size</option>
                                                    <option value="1.4"{{$layout_configuration->text_time_size == "1.4" ? 'selected' : ''}}>x4 Size</option>
                                                    <option value="1.6"{{$layout_configuration->text_time_size == "1.6" ? 'selected' : ''}}>x6 Size</option>
                                                    <option value="2"{{$layout_configuration->text_time_size == "2" ? 'selected' : ''}}>x8 Size</option>
                                                  </select>
                                            </div>
                                        </div>
                                    </div>
