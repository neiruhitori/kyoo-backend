    ...
    <table>
        ...
        <thead>
            <tr>
                ...
                <th rowspan="2" style="width: 120px; font-weight: bold;">{{ __('Service') }}</th>
                <th colspan="3" style="font-weight: bold; text-align: center">{{ __('Total Queue') }}</th>
                <th rowspan="2" style="width: 120px; font-weight: bold; text-align: center">{{ __('Operational Hours') }}</th>
                <th rowspan="2" style="width: 120px; font-weight: bold; text-align: center">{{ __('Total Serving Time') }}</th>
                <th rowspan="2" style="width: 120px; font-weight: bold; text-align: center">{{ __('Total Idle Time') }}</th>
                <th rowspan="2" style="width: 120px; font-weight: bold; text-align: right">{{ __('Productivity') }}</th>
