...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{route('admin-branch.branch-configuration.device-account.update', $user->id)}}" method="post">
                @csrf
                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">DEV{{Auth::user()->branch_id}}_</span>
                                        </div>
