...
<div class="form-group">
    ...
    <input name="admin_password" type="password" class="form-control @error('admin_password') is-invalid @enderror" value="">
    @include('layouts.inputError', ['errorName' => 'admin_password'])
</div>
<div class="form-group">
    <label for="admin_password_confirmation">Confirmation Password</label>
    <input name="admin_password_confirmation" type="password" class="form-control @error('admin_password_confirmation') is-invalid @enderror" value="">
