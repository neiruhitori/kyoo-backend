...
<div class="form-group">
    ...
    <input name="fixed_phone" type="text" class="form-control @error('fixed_phone') is-invalid @enderror" value="{{old('fixed_phone') ?: $branch->fixed_phone}}" required>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            const schedule_template_idOldValue = '{{ old('schedule_template_id') ?: $branch->schedule_template_id }}';
