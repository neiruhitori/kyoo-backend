...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input name="lat" type="text" class="form-control @error('lat') is-invalid @enderror" value="{{old('lat')}}">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input name="long" type="text" class="form-control @error('long') is-invalid @enderror" value="{{old('long')}}">
