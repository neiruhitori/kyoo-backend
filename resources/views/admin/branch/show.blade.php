            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        @endisset
                        <p class="mt-3">{{ __('Image Background') }}:</p>
                        @isset($branch->photo)
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>{{ __('Fixed Phone') }}: <b>{{$branch->fixed_phone ?: '-'}}</b></li>
                                            <li>{{ __('Mobile Phone') }}: <b>{{$branch->mobile_phone}}</b></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    <th>{{ __('Services Likes') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($branch->is_active)
                                        <h5 class="badge badge-primary">{{ __('Yes') }}</h5>
                                        @else
                                        <h5 class="badge badge-danger">{{ __('No') }}</h5>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.011310751414!2d107.5938467146131!3d-6.889247869328712!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e69314ebee4b%3A0xbc5831d22e61beeb!2sParis%20Van%20Java%20Resort%20Lifestyle%20Place!5e0!3m2!1sid!2sid!4v1587043514969!5m2!1sid!2sid"
                                ...
                                <tr>
                                    <th colspan="2">
                                        <br>
                                        <br>
                                        <h5>{{ __('Services Days and Times') }}</h5>
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    <th>{{ __('Expired At') }}</th>
                                    <td>{{date('Y-m-d H:i:s', strtotime($branch->BranchToken->created_at . ' + 1
                                        year'))}}</td>
                                </tr>
                                @endif
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        {{ __('Are you sure want to unregister this branch?') }}
                                                    </div>
                                        ...
                                        <div class="text-right">
                                            <a href="{{route('admin.branch.index')}}" class="btn btn-primary">
                                                {{ __('Back') }}
                                            </a>
                                        </div>
                                    </td>
