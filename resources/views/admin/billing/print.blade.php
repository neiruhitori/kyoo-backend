  ...
  <div class="ribbon">
    ...
    <div class="mx-3 my-3">
        <div class="row" style="margin-bottom: 200px">
            <div class="col-md-12">
                <img src="{{ asset('img/kyoo-logo.png') }}" style="width: 15vh; margin-top: 50px">
        ...
        {{-- <div class="d-flex justify-content-end">
            ...
            @elseif($print->status == "PENDING")
            <div>
              <h3 style="color:black;"><b>Status : </b><span class="badge badge-warning px-3"  style="color:black; border: none;">PENDING</span></h3>
            </div>
            @else
            <div>
              <h3><b style="color:black;">Status : </b><span class="badge badge-danger px-3"  style="border: none;">EXPIRED</span></h3>
            </div>
        ...
        <div class="row mb-2">
            <div class="col-md-12 py-2" style="background-color:#a2a2a288; color:black">
                <h2 ><b>Invoice #{{ $print->invoice_number }}</b></h2>
                <h5>Invoice Date: {{ \Carbon\Carbon::parse($print->created_at)->translatedFormat('d/m/Y')}} </h5>
                <h5>Due Date: {{ \Carbon\Carbon::parse($print->expiry_date)->translatedFormat('d/m/Y')}}</h5>
            </div>
        </div>
        </div>
        <div class="row">
...
.form-control:focus {
  ...
  border-color: #76cfef;
  outline: 0;
  -webkit-box-shadow: 0 0 0 0.2rem rgba(24, 157, 205, 0.25);
          box-shadow: 0 0 0 0.2rem rgba(24, 157, 205, 0.25);
}
...
.btn-primary:focus, .btn-primary.focus {
  -webkit-box-shadow: 0 0 0 0.2rem rgba(59, 172, 213, 0.5);
          box-shadow: 0 0 0 0.2rem rgba(59, 172, 213, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  -webkit-box-shadow: 0 0 0 0.2rem rgba(24, 157, 205, 0.5);
          box-shadow: 0 0 0 0.2rem rgba(24, 157, 205, 0.5);
}
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(24, 157, 205, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  -webkit-box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(24, 157, 205, 0.25);
          box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(24, 157, 205, 0.25);
}
...
.bg-primary {
  background-color: #189DCD !important;
}

a.bg-primary:hover, a.bg-primary:focus,
button.bg-primary:hover,
button.bg-primary:focus {
  background-color: #137a9f !important;
}
...
.text-primary {
  color: #189DCD !important;
}

a.text-primary:hover, a.text-primary:focus {
  color: #106989 !important;
}
...
.bg-gradient-primary {
  background-color: #189DCD;
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(10%, #189DCD), to(#106989));
  background-image: linear-gradient(180deg, #189DCD 10%, #106989 100%);
...
.border-left-primary {
  border-left: 0.25rem solid #189DCD !important;
}

.border-bottom-primary {
  border-bottom: 0.25rem solid #189DCD !important;
}
