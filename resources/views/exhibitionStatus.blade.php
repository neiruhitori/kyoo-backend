                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">{{ __('Queue Status') }}</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-right">
                                        <b>{{ $queue->Slot->Service->Branch->name }}</b>
                                    </div>
                                    ...
                                    <div class="col-md-8 text-right">
                                        <b>{{ $queue->Slot->start_time }} - {{ $queue->Slot->end_time }}</b>
                                    </div>

                                    <div class="col-md-12 mt-3">
                                        <h3>{{ __('Queue Detail') }}</h3>
                                        <hr>
                                    </div>
                                    ...
                                    <div class="col-md-8 text-right">
                                        <b class="text-primary" style="font-size: 26px">{{ $queue->queue_order }}</b>
                                    </div>
