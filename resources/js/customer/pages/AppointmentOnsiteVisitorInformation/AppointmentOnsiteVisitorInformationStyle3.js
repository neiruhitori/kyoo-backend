...
function AppointmentOnsiteVisitorInformation() {
    ...
    return <>
        ...
        <div style={{ background:'url(/img/bgstyle3.jpg) right top / cover no-repeat fixed',
                  display:'flex', flexDirection:'column', flex:'1 1 0%',backgroundColor: '#103c7c'
     }}>
        <Header>
            <div style={{
                height: '3.2rem',
        ...
        <div style={{ padding: '2rem 3.5rem 1.375rem', display:'flex', 
                    color:'white', justifyContent:'space-around' }}>
            <div>
                <h2 style={{ marginBottom:'0.8rem' }}>{t('Visitor Information')}</h2>
                <p>{t('Please fill in your data')}</p>
            </div>
            <img src='/img/clipboard.png' style={{ height:'8rem'}} />
        </div>
